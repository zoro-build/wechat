...
勾选文章即可批量把图文正文抓到本地，排版原样保留。感兴趣的文章可点**星标**，用「只看星标」跨公众号筛出后再批量抓取或下载。图片自动重试、缺图会有提示；同一篇文章自动去重，不会重复抓取。
...
- **购买方式**：提供**按 3 年 / 按年 / 按月**三种，按需选择；**购买期限内提供功能更新与问题修复**；当前为内测优惠价，内测结束后将恢复原价。
